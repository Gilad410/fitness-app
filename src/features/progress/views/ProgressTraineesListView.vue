...
// Trainee picker for the "התקדמות" main area -- mirrors
// NutritionTraineesListView.vue exactly (same filter UI, same loading/error
// states). Selecting a trainee here opens their progress workspace at
// /progress/:id, which reuses the same progress components already shown on
// the trainee-detail page -- no duplicated logic.
  ...
  <AppLayout>
    <div class="mx-auto max-w-lg">
      <section class="mb-6 sm:mb-8">
        <h1 class="text-2xl font-bold text-brand-black sm:text-3xl">התקדמות</h1>
        <p class="mt-1 text-sm text-neutral-600">בחר מתאמן כדי לפתוח את מרחב ההתקדמות שלו</p>
      </section>
