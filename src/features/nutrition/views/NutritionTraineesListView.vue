...
// Trainee picker for the "תזונה" main area -- a separate entry point from
// "לקוחות" (TraineesListView) so that page can stay profile/progress-only.
// Selecting a trainee here opens their nutrition workspace at
  ...
  <AppLayout>
    <div class="mx-auto max-w-lg">
      <section class="mb-6 sm:mb-8">
        <h1 class="text-2xl font-bold text-brand-black sm:text-3xl">תזונה</h1>
