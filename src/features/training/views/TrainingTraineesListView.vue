...
// Trainee picker for the "תוכניות אימון" main area -- mirrors
// NutritionTraineesListView.vue / ProgressTraineesListView.vue exactly
// (same filter UI, same loading/error states). Selecting a trainee here
// opens their program list at /training/:traineeId.
  ...
  <AppLayout>
    <div class="mx-auto max-w-lg">
      <section class="mb-6 sm:mb-8">
        <h1 class="text-2xl font-bold text-brand-black sm:text-3xl">תוכניות אימון</h1>
        <p class="mt-1 text-sm text-neutral-600">בחר מתאמן כדי לנהל את תוכניות האימון שלו</p>
      </section>
