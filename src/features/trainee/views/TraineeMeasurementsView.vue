                  ...
                  <template v-if="session.byAngle[angle.key]">
                    ...
                    <template v-if="confirmDeletePhotoId === session.byAngle[angle.key].id">
                      <button
                        ...
                        class="inline-flex min-h-11 min-w-11 items-center justify-center rounded-lg bg-status-red px-2 py-1 text-xs font-medium text-brand-white hover:bg-status-red/90 disabled:cursor-not-allowed disabled:opacity-60"
                      ...
                      <button
                        type="button"
                        :disabled="photosStore.deletingId === session.byAngle[angle.key].id"
                        class="inline-flex min-h-11 min-w-11 items-center justify-center rounded-lg border border-neutral-300 px-2 py-1 text-xs font-medium text-brand-black hover:bg-neutral-100 disabled:cursor-not-allowed disabled:opacity-60"
