...
const sample = JSON.parse(readFileSync(path.join(here, 'out/sample_50_current.json'), 'utf8'))
...
writeFileSync(path.join(here, 'out/sample_50_fresh_images.json'), JSON.stringify(results, null, 2))
